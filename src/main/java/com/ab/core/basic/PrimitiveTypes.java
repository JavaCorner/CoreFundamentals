 ...
 * You can add underscores anywhere except at the beginning, at the end, right before/after a decimal.
 *
...
public class PrimitiveTypes {
    ...
    public static void main(String[] args) {
        ...
        //long l2 = 2147483648;                 //compile error since the value treated as int but out of range as per int range
        long l3 = 2147483648L;
        long l4 = 9223372036854775807L;

        float f1 = 2147483647;                  //here the literal is treated as an int and compiler cast it to float
        //float f2 = 2147483648;                //compile error since the value treated as int but out of range as per int range
        float f3 = 2147483648L;
        //float f4 = 99999999999999999999999999999999999999L;//compile error since the value treated as long but out of range as per long range
